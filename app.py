...
description = pd.read_csv("description.csv")  # Adjust file path
...
# Functions for fetching details
def helper(dis):
...
symptoms_input = st.text_input("Enter your symptoms (comma-separated, e.g., itching, skin_rash)")
...
if st.button("Get Prediction"):
    if symptoms_input:
        ...
        # Get details about the predicted disease
        ...
        for i, workout in enumerate(wrkout, 1):
